...
# aliyun redis 配置
ARG ALIYUN_REDIS_HOST
ARG ALIYUN_REDIS_PORT
ARG ALIYUN_REDIS_PASSWORD
...
# aliyun redis配置
ENV ALIYUN_REDIS_HOST $ALIYUN_REDIS_HOST
ENV ALIYUN_REDIS_PORT $ALIYUN_REDIS_PORT
ENV ALIYUN_REDIS_PASSWORD $ALIYUN_REDIS_PASSWORD
